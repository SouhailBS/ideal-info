...
<div class="shop_toolbar_wrapper">
    <div class="shop_toolbar_btn">
        <button data-role="grid_3" type="button" class="btn-grid-3" data-bs-toggle="tooltip"
                title="3"></button>
        <button data-role="grid_4" type="button" class="btn-grid-4 @if($products->count()>5) active @endif"
                data-bs-toggle="tooltip"
                title="4"></button>
        <button data-role="grid_list" type="button" class="btn-list @if($products->count()<=5) active @endif"
                data-bs-toggle="tooltip"
                title="List"></button>
    </div>
